# 1d2d
Online 1d and 2D barcode (QR Code) Generator

The bwip-js online API is hosted on an [Locally in Wolver Home Lab](http://home.wolver.com/) using a node.js application.  You can use this API to dynamically generate barcode images from anywhere on the web.  The returned image is in PNG format.
